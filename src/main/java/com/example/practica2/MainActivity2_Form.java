...
public class  MainActivity2_Form extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if(validarEmail(correo) && validaDni(dni) && validar() && validarNombre(nombre)){
           ...
           Intent intento = new Intent(this,BaseDeDatos.class);
            ...
            //registro el usuario regsitrado en la lista de la base de datos
            bbdd.registrarDatos(new DatosRegistro(nombre,dni,correo,eleccion,boletin));

            Toast toast = Toast.makeText(this, "Datos enviados correctamente", Toast.LENGTH_LONG);
            toast.show();
